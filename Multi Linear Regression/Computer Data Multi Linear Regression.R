...
# Adjusted R2 Value - with Y = Price and X = Speed as 0.09044
# Adjusted R2 Value - with Y = Price and X = Speed+hd as 0.2079
# Adjusted R2 Value - with Y = Price and X = Speed+hd+ram as 0.4332
# Adjusted R2 Value - with Y = Price and X = Speed+hd+ram+screen as 0.4583
# Adjusted R2 Value - with Y = Price and X = Speed+hd+ram+screen+cd as 0.4648
# Adjusted R2 Value - with Y = Price and X = Speed+hd+ram+screen+cd+multi as 0.4648
# Adjusted R2 Value - with Y = Price and X = Speed+hd+ram+screen+cd+multi+premium as 0.5038
# Adjusted R2 Value - with Y = Price and X = Speed+hd+ram+screen+cd+multi+premium+ads as 0.5307
